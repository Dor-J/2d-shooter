...
- **Completed milestones:** Tasks 1, 3–8. Task 2's deterministic native/Wasm foundation is complete; its intentionally ongoing “add fixtures as later features land” checkbox remains open.
- **Current coverage:** 1,104 gap features are mapped; 262 `Present` features have passing evidence in `docs/parity/coverage.json`.
